...
queryRange = totalRecords + (totalRecords /20)

totalQueries = totalRecords/100
print('Upserts to be executed: ', int(totalQueries))

maxQueryInterval = 86400 / queryRange
minQueryInterval = 345600 / queryRange
